<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMasterPage.master" AutoEventWireup="true" CodeFile="ReportData.aspx.cs" Inherits="ReportData" %> 
            ...
            <div class="form-horizontal" role="form">
                <div class="form-group">
                    <asp:GridView ID="gvFirstGrid" runat="server" AutoGenerateColumns="true" CssClass="table table-condensed table-bordered table-hover table-responsive" OnRowDataBound="GV_CustomerList_RowDataBound" RowStyle-CssClass="gvItemStyle" AllowPaging="false" OnPageIndexChanging="gvFirstGrid_PageIndexChanging" Pazesize="10" PagerSettings-Mode="NumericFirstLast">
                        ...
                        <asp:GridView ID="GV_ExportFirstGrid" runat="server" AutoGenerateColumns="true" CssClass="table table-condensed table-bordered table-hover table-responsive" OnRowDataBound="GV_CustomerList_RowDataBound" Visible="false">
        ...
        <div class="panel-body">
            <div class="form-horizontal" role="form">
                <div class="form-group">
                    ...
                    <asp:GridView ID="GV_ExportSecondGrid" runat="server" AutoGenerateColumns="true" CssClass="table table-condensed table-bordered table-hover table-responsive"  Visible="false">
                        <HeaderStyle HorizontalAlign="Center" />
                    </asp:GridView>
                </div>
            </div>
