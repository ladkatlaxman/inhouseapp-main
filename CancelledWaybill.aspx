<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMasterPage.master" AutoEventWireup="true" CodeFile="CancelledWaybill.aspx.cs" Inherits="CancelledWaybill" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <!---Update Progress 1 ---->
    <asp:UpdateProgress ID="UpdateProgress_CancelledWaybill" AssociatedUpdatePanelID="UpdatePanel_CancelledWaybill" runat="server" DisplayAfter="0">
        <ProgressTemplate>
            <div id="overlay">
    ...
    <div class="panel panelTop">
        <asp:UpdatePanel ID="UpdatePanel_CancelledWaybill" runat="server">
            <ContentTemplate>

                <div class="panel-heading panelHead">
                    <b>WAYBILL CANCELLED</b>
                </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-xs-5 col-sm-6 col-md-4 col-lg-3 col-xl-2">
                                    ...
                                    <asp:Label ID="lbl_SearchWaybillNo" runat="server" CssClass="label labelColor">WAYBILL NO</asp:Label><span class="required">*</span>
                                    <asp:TextBox ID="Txt_WaybillNo" runat="server" onkeypress="return validateNumericValue(event)" MaxLength="7" TabIndex="1" CssClass="form-control input-sm Txt_WaybillNo FirstNoSpaceAndZero"></asp:TextBox>                                
                                </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                ...
                                <div class=" col-sm-2 col-md-2 col-lg-1 col-xl-1">
                                    <div class="form-control-sm"></div>
                                    <asp:LinkButton ID="Button_Submit" runat="server" TabIndex="3" CssClass="btn btn-info largeButtonStyle" UseSubmitBehavior="false" OnClientClick="if (!validateWaybillCancelled()) {return false;};" OnClick="Button_Submit_Click">SUBMIT&nbsp;<i class="fa fa-save"></i></asp:LinkButton>
                                </div>
                                <div class=" col-sm-2 col-md-2 col-lg-1 col-xl-1">
                                    <div class="form-control-sm"></div>
