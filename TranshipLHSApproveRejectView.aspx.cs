...
public partial class TranshipLHSApproveRejectView : System.Web.UI.Page
{
    ...
    {
        List<VehicleRequestProperties> ViewList = (new VehicleRequestFunction()).ViewTranshipVehicleCreatedData(Convert.ToInt32(Session["BranchId"]));
        GV_TranshipApprovedRejectView.DataSource = ViewList;
        GV_TranshipApprovedRejectView.DataBind();
    }
    protected void VehicleStatusCheck()
    {
        foreach (GridViewRow row in GV_TranshipApprovedRejectView.Rows)
        {
