<%@ Page Title="" Language="C#" MasterPageFile="~/AdminMasterPage.master" AutoEventWireup="true" CodeFile="TranshipLHSApproveRejectView.aspx.cs" Inherits="TranshipLHSApproveRejectView" %>
                                ...
                                <asp:UpdatePanel ID="UpdatePanel_VehicleHiringStatusView" runat="server">
                                    <ContentTemplate>
                                        <div class="form-group">
                                            <asp:GridView ID="GV_TranshipApprovedRejectView" runat="server" CssClass="table table-condensed table-bordered table-hover table-responsive" AutoGenerateColumns="false">
                                                <Columns>
