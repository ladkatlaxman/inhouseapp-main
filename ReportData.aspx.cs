...
public partial class ReportData : System.Web.UI.Page
{
    ...
    {
        Response.Redirect("ReportDataOne.aspx"); 
        string str = "";
  ...
  [WebMethod]
    ...
    public void fillGrid()
    {
        ...
        if (GV_ExportFirstGrid.Rows.Count > 0)
        {
            //// Header column names
            int gridViewCellCount = GV_ExportFirstGrid.Rows[0].Cells.Count;
            ...
            {
                //columnNames[i] = ((DataControlFieldCell)(GV_ExportFirstGrid.Rows[0].Cells[i])).ContainingField.HeaderText;
                if (strGetType == "VEHICLEREQUESTS")
                {
                    if (((DataControlFieldCell)(GV_ExportFirstGrid.Rows[0].Cells[i])).ContainingField.HeaderText == "LHS No")
                    {
                        strManifestColumnNo = i;
                        //break;
                    }
                    if (((DataControlFieldCell)(GV_ExportFirstGrid.Rows[0].Cells[i])).ContainingField.HeaderText == "DRS No")
                    {
                        strDRSNo = i;
                        //break;
                    }
    ...
    protected void GV_CustomerList_RowDataBound(object sender, System.Web.UI.WebControls.GridViewRowEventArgs e)
    {
        if (strGetType.ToUpper() == "MOVINGVEHICLE")
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                if (e.Row.Cells[strManifestColumnNo].Text != "" & e.Row.Cells[strManifestColumnNo].Text != "&nbsp;")
                {
                    ...
                    txtManifest.NavigateUrl = "ReportData.aspx?value=LHS&identity=" + e.Row.Cells[10].Text;
        ...
        if (strGetType.ToUpper() == "VEHICLEREQUESTS" || strGetType == "VEHICLEMOVEMENT") 
        {
	    ...
	    if (bstrDone == 0)
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                txt.NavigateUrl = "ReportData.aspx?VehicleRequestId=" + e.Row.Cells[0].Text;
                ...
                {
                    HyperLink txtManifest = new HyperLink();
                    txtManifest.NavigateUrl = "ReportData.aspx?value=LHS&identity=" + e.Row.Cells[1].Text;
                ...
                if (e.Row.Cells[strDRSNo].Text != "" & e.Row.Cells[strDRSNo].Text != "&nbsp;")
                {
                    ...
                    txtDRS.NavigateUrl = "ReportData.aspx?value=DRS&identity=" + e.Row.Cells[1].Text;
